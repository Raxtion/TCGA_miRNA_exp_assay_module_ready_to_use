...
def running(ori_path = '', N_source_path = '', T_source_path = '', Raxpy3CPU = 'Raxpy3LibmultiCPU_2013_09_15', Final_file_Name = 'TCGASTAD_NT_top3_mixarm_0to1.txt', ZeroChange = 1, Top_processing = 14):
    import os, time
...
for file_name in test_type_list:
    ...
    #file_name = 'bcgsc.ca__IlluminaHiSeq_miRNASeq__TCGA-B7-5816-01A-21R-1602-13__isoform_quantification_1_cleaned.txt'
    _M = file_mir_marker_dic[file_name]
    _E = []
...
#-----------------------------------------------------------------------------------------------
#TabT modify 0to1 and delete 'order'
...
f.close()
    ...
    output_file_Name = 'TabTouT_for_N_mixarm.txt'
    ...
    output_file_Name = 'TabTouT_for_T_mixarm.txt'
    mulitCUP_for_TCGA_data(ori_path, source_path, output_file_Name, Raxpy3CPU)
    ...
    file_list = [x for x in os.listdir(ori_path) if 'TabTouT_for_' in x and 'mixarm.txt' in x]
